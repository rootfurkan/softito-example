...
const Toggle = ()=>{
    ...
    return(
        <div className='p-4'>
            <h3 className='demo-title'>Demo 2 : Mantıksal (boolen) State Yönetimi</h3>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <button type='button' onClick={sifreToggle} className='btn-password-toggle'>{sifreGoster ? "Gizle" : "Goster"}</button>
                        </div>
                    </div>
                    <div className="demo-state-info">
                        <strong>Durum Bilgisi</strong>
                        <ul className='demo-info-list'>
                            <li>Gece Modu: <code>{geceModu ? "Açık" : "Kapalı"}</code></li>
